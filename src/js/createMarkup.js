...
const failedSearch = document.querySelector('.header__failed-search-msg');

export function createMarkup(moviesArray) {
        ...
        return `
                <li class="main__movie-card-item">
                    ...
                    <div class="main__movie-info">
                        ...
                        <p class="main__movie-raiting">${movieRaiting}</p>
                    </div>
                </li>
        `}).join('');
